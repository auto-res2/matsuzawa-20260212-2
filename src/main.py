...
def main(cfg: DictConfig):
    ...
    # [PROBLEM]: CLI uses run= parameter but code references cfg.runs
    # [CAUSE]: Directory was named runs/ creating runs config group, but CLI expects run=
    # [FIX]: Renamed directory to run/ and reverted all cfg.runs to cfg.run
    #
    # [OLD CODE (Attempt 1)]:
